// Publishes one Clip Studio post to one Instagram account: container → upload → processing → publish.
//
...
/** The connected Instagram login behind a Clip Studio account: by igUserId, else by matching handle. */
