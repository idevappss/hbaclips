...
// ---------------------------------------------------------------------------
// Built in: the fonts and effect blocks already bundled with Clip Studio in assets/, shown read-only.
...
async function builtins() {
  ...
  for (const name of await read("fonts")) {
    ...
    out.push({
      ...
      notes: "Bundled with Clip Studio for captions and titles.",
      tags: ["built-in"],
  ...
  for (const name of await read("registry")) {
    ...
    out.push({
      ...
      notes: "HyperFrames block bundled with Clip Studio (assets/registry).",
