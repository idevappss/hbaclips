...
${Object.entries(CLIP_FACTORS).map(([key, f]) => `     ${key}: ${f.hint}`).join("\n")}
   ...
   - on_screen_title is the headline burned into the video: max 8 words, the premise or the payoff stated plainly, premium voice; title_highlight is its single strongest word.
   - post_title, post_caption (1–3 sentences ending with a clear, understated call to action) and hashtags (3–5, no spaces) are ready-to-paste posting copy.
