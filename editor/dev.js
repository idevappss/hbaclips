// Dev server for the timeline editor (port 5193). Serves HBA Content Backend's page from disk with the editor router
// mounted and proxies everything else to the running HBA Content Backend server (5173), which it never restarts.
...
// HBA Content Backend writes projects to disk as they change; read them fresh here instead of through its cache.
...
// The page and its scripts straight from disk, so edits to public/ show up without restarting HBA Content Backend.
